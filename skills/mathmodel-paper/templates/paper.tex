% 出处：主技能 skills/mathmodel-core/SKILL.md「LaTeX模板（精简版）」小节（原样提取，占位示例保留）
...
% ========== 西文字体：优先 Times New Roman，缺失时回退度量兼容的 TeX Gyre Termes ==========
% 竞赛交付环境（Windows/Word）使用 Times New Roman；TeX Live 等不含该商业字体的环境自动
% 回退到度量兼容字体，因此 CI 不再需要替换字体，用户侧仍得到 Times New Roman。
